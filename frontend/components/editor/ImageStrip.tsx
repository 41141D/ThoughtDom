      ...
      {images.map((img) => (
        <div key={img.id} className="group relative animate-fade-in-up">
          ...
          <button
            ...
            className="absolute -top-1.5 -right-1.5 h-5 w-5 rounded-full bg-danger text-white text-xs leading-none flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
            title="Remove image"
          >
            ×
          </button>
